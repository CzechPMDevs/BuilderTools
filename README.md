...
- BuilderTools supports loading [MCEdit](https://minecraft.wiki/w/Schematic_file_format) and [MCStructure](https://minecraft.wiki/w/Structure_Block#Save) formats and creating schematics wth MCEdit format.
...
- Currently, we support only [Anvil](https://minecraft.wiki/w/Anvil_file_format) world format
